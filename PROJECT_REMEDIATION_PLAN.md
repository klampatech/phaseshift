...
| 10 — Gameplay mechanics, playability & fun pass | ⏳ Brief ready | Working tree | 14 sub-phases (§10.1 → §10.14) sequenced P0 → P1 → P2. P0 (§10.1 → §10.5) required for fun: energy rebalance (§10.1), Phase Fuse / Memory World (§10.2), collapse penalty = Echo loss (§10.3), sequenced 30+ Echo lore (§10.4), Nexus finale + Act 4 Convergence (§10.5). P1 (§10.6 → §10.9): per-biome signature mechanics, drop LMB/RMB block edit, wire up erosion, energy danger states. P2 (§10.10 → §10.14): Echo Hunter panel, wrong-phase Echoes, phase shift preview, resonance charge-up, New Game+. Estimated ~170 new headless checks. See `PHASE_10_BRIEF.md`. |
