...
| 10 — Gameplay mechanics, playability & fun pass | ✅ Done (P0 + P1) | `c7b4723` | P0 §10.1 → §10.5 + P1 §10.6, §10.7, §10.8, §10.9 all shipped. P2 §10.10 → §10.14 (Echo Hunter panel, wrong-phase Echoes, phase shift preview, resonance charge-up, New Game+) deferred per the brief's "cut P2 if needed" note. Highlights: §10.1 `PHASE_SHIFT_COST` 5→15 + per-second drain in Beta/Gamma; §10.2 Phase Fuse (3s hold, 30 energy, persistent Memory World); §10.3 collapse = 1 random Echo lost; §10.4 36-Echo biome-sequenced narrative; §10.5 Act 4 Convergence + Nexus finale; §10.6 per-biome signature mechanics (Forest 2× Echoes, Crystal Cavern 2× Cores, Deep Void 2× Glider, Sky Ruins 2× Anchor, Desert unique, Nexus = all); §10.7 dropped LMB/RMB (Path A) + fixed UI labels; §10.8 wired up phase erosion (was dead code); §10.9 energy danger states (HUD throb + audio heartbeat + vignette pulse + 5s Alpha grace). 281 new headless checks across 9 new test files. See `PHASE_10_BRIEF.md` + `HANDOFF.md` §Phase 10 closure. |
