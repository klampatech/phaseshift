...
| 3 — World feel | In progress | 3.1 ✅ + 3.2 ✅ + 3.3 ✅ | Phase 3.1 (Biomes), 3.2 (Stabilizers + collapse state machine), 3.3 (Echoes + HUD counter + lore toast) shipped. Phase 3.4 (Resonance Cores) is up next — see `PHASE_3_4_BRIEF.md`. |
